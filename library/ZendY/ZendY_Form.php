...
/**
 * Description of ZendY_Form
 *
 * @author Josefina
 */
class ZendY_Form extends Zend_Form {
    ...
    public function loadDefaultDecorators() {
        ...
        if (!$this->loadDefaultDecoratorsIsDisabled()) {
            ...
            $this->clearDecorators()
                    ...
                    ->addDecorator('HtmlTag', array('tag' => 'div', 'class' => 'scMain', 'id'=>'SmartCart'))
                    ->addDecorator('Form')
        ...
        foreach ($this->getDisplayGroups() as $group) {
            ...
            if ($group->loadDefaultDecoratorsIsDisabled())
                continue;
