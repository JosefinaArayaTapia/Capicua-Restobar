...
(function($){
    $.fn.smartCart = function(options) {
        ...
        return this.each(function() {
                ...
                // Labels & Messages              
                var labelCartMenuName = 'Venta (_COUNT_)';  // _COUNT_ will be replaced with cart count
                var labelCartMenuNameTooltip = "Venta | Total Productos: _PRODUCTCOUNT_ | Total cantidad: _ITEMCOUNT_";
                var labelProductMenuName = 'Productos';
                var labelSearchButton = "Buscar";
                var labelSearchText = "Buscar";
                var labelCategoryText = "Tipo Producto";
                var labelClearButton = "limpiar";
                var labelAddToCartButton = "Agregar"; 
                var labelQuantityText = "cantidad";
                var labelProducts = 'productos';
                var labelPrice = 'precio';
                var labelSubtotal = 'Subtotal';
                var labelTotal = 'Total $';
                var labelRemove = 'Eliminar';
                var labelCheckout = 'Confirmar';
                
                var messageConfirmRemove = '¿Esta seguro de eliminar  "_PRODUCTNAME_" de la venta?'; //  _PRODUCTNAME_ will be replaced with actula product name
                var messageCartEmpty = "La venta esta vacia";
                var messageProductEmpty = "No hay productos";
                var messageProductAddError = "Producto no pudo ser agregado";
                var messageItemAdded = 'Producto agregado a la venta';
                var messageItemRemoved = 'Producto eliminado de la venta';
                var messageQuantityUpdated = 'Cantidad de producto actualizada';
                var messageQuantityErrorAdd = 'Cantidad invalida. Producto no agregado';
                var messageQuantityErrorUpdate = 'Cantidad invalida. cantidad no agregada';
    ...
    $.fn.smartCart.defaults = {
          ...
          productItemTemplate:'<strong><%=pname%></strong><br />Tipo de Producto: <%=pcategory%><br /><small><%=pdesc%></small><br /><strong>Precio : $<%=pprice%></strong>',
