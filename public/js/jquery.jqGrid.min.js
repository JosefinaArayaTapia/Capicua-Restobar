...
* Date:2010-02-14 
* Modules: grid.base.js; jquery.fmatter.js; grid.custom.js; grid.common.js; grid.formedit.js; jquery.searchFilter.js; grid.inlinedit.js; grid.celledit.js; jqDnR.js; grid.jqueryui.js; 
*/
(function(b){
    b.jgrid=b.jgrid||{};
    ...
    b.extend(b.jgrid,{
        ...
        stripHtml:function(f){
            f+="";
            var k=/<("[^"]*"|'[^']*'|[^'">])*>/gi;
            if(f)return(f=f.replace(k,""))&&f!=="&nbsp;"&&f!=="&#160;"?f:"";else return f
                },
...
populateVisible:function(){
    ...
    if(c){
        ...
        if(e){
            g.prevRowHeight=
            e;
            var l=h.rowNum,n=g.scrollTop=g.bDiv.scrollTop,s=Math.round(d.position().top)-n,p=s+d.height();
            e=e*l;
            var w,r,o;
...
selectionPreserver:function(c){
    var d=c.p,e=d.selrow,l=d.selarrrow?b.makeArray(d.selarrrow):null,n=c.grid.bDiv.scrollLeft,s=d.gridComplete;
...
if(this.p.colNames.length!==this.p.colModel.length)alert(b.jgrid.errors.model);
    ...
    var q=b("<div class='ui-jqgrid-view'></div>"),u,y=b.browser.msie?true:false,B=b.browser.safari?true:false;
    a=this;
    ...
    if(y)b.jgrid.empty.apply(e[0]);else e[0].innerHTML="";
    if(d&&a.p.scroll){
        b(">div:first",c).css({
            height:"auto"
...
return e
    ...
    if(b.isXMLDoc(c)){
        ...
        var p,w=0,r,o,v=0,x=0,z=0,D,N,L=[],P,G={},ba=a.rows.length,E,V,C=[],Q=0,da=a.p.altRows===true?" "+a.p.altclass:"";
        ...
        var ea=c.length,O=0;
        if(c&&ea){
            var ka=parseInt(a.p.rowNum,10),wa=a.p.scroll?(parseInt(a.p.page,10)-1)*ka+1:1;
            if(n)ka*=n+1;
    ...
    if(c){
        ...
        var p=0,w,r,o,v=[],x,z=0,D=0,N=0,L,P,G,ba={},E,V=a.rows.length,C;
        o=[];
        E=0;
        var Q=
        ...
        if(v.length>0&&!isNaN(G)){
            ...
            var da=parseInt(a.p.rowNum,
                10),ea=a.p.scroll?(parseInt(a.p.page,10)-1)*da+1:1;
            if(n)da*=n+1;
...
b.isFunction(a.p.gridComplete)&&a.p.gridComplete.call(a)
    ...
    if(!a.grid.hDiv.loading){
        ...
        var s=a.p.loadComplete,p=b.isFunction(s);
        p||(s=null);
        var w=0;
        c=c||1;
...
fa=function(){
    ...
    var c=/[\$,%]/g,d=[],e=0,l,n,s,p=a.p.sortorder=="asc"?1:-1;
...
u=function(c,d){
    var e="",l="<table cellspacing='0' cellpadding='0' border='0' style='table-layout:auto;' class='ui-pg-table'><tbody><tr>",n="",s,p,w,r,o=function(v){
        a.p.selrow=null;
        if(a.p.multiselect){
            a.p.selarrrow=
            [];
...
b("#first"+
    ...
    var v=J(a.p.page,1),x=J(a.p.lastpage,1),z=false,D=true,N=true,L=true,P=true;
...
var xa=function(c,d,e,l){
    ...
    for(d=e[0]=e[1]=e[2]=0;d<=c;d++)if(a.p.colModel[d].hidden===false)e[0]+=a.p.colModel[d].width+l;if(a.p.direction=="rtl")e[0]=a.p.width-e[0];
...
if(a.p.scroll){
    ...
    var H="<thead><tr class='ui-jqgrid-labels' role='rowheader'>",ya,ga,sa,ha,na,I,A,ca;
ga=ca="";
...
if(a.p.autowidth===true){
    ...
    var c=0,d=a.p.cellLayout,e=0,l,n=a.p.scrollOffset,s,p=false,w,r=0,o=0,v=0,x;
    if(B)d=0;
...
if(isNaN(a.p.width))a.p.width=g.width=c;else g.width=a.p.width;
    a.p.tblwidth=
    c;
...
setSelection:function(f,k){
    return this.each(function(){
        function i(a,q){
            var u=b(h.grid.bDiv)[0].clientHeight,y=b(h.grid.bDiv)[0].scrollTop,B=h.rows[a].offsetTop+h.rows[a].clientHeight;
    ...
    this.each(function(){
        ...
        if(typeof f=="undefined"){
            ...
            b("td",q).each(function(u){
                ...
                if(a!=="cb"&&a!=="subgrid")if(m.p.treeGrid===true&&a==m.p.ExpandColumn)k[a]=b.jgrid.htmlDecode(b("span:first",this).html());else try{
                    k[a]=b.unformat(this,{
                        rowId:q.id,
...
setRowData:function(f,k,i){
    ...
    if(q==="string")b(a).addClass(i);else q==="object"&&
        b(a).css(i)
        });
return g
},
addRowData:function(f,k,i,h){
    i||(i="last");
    var g=false,j,m,a,q,u,y,B,K,J="",F,S,M;
    if(k){
        if(b.isArray(k)){
            F=true;
            i="last";
        ...
        if(t.p.altRows===true&&!F)if(i=="last")(t.rows.length-1)%2==1&&b(t.rows[t.rows.length-1]).addClass(M);else b(t.rows).each(function(T){
...
footerData:function(f,k,i){
    function h(a){
        for(var q in a)return false;return true
        }
        var g,j=false,m={};
        ...
        if(i.grid){
            ...
            b(this.p.colModel).each(function(j){
                if(b.inArray(this.name,f)!==-1&&this.hidden===g){
                    ...
                    if(k=="none")i.p.tblwidth-=this.width;else i.p.tblwidth+=this.width;
                    this.hidden=!g;
                    h=true
                    }
                });
...
remapColumns:function(f,k,i){
    function h(m){
        ...
        b(">tr"+(a||""),m).each(function(){
            var q=this,u=b.makeArray(q.cells);
            b.each(f,function(){
                var y=u[this];
                y&&q.appendChild(y)
                })
    ...
    if(j.p.remapColumns)if(j.p.remapColumns.length)h(j.p.remapColumns);else j.p.remapColumns=b.makeArray(f);
    j.p.lastsort=b.inArray(j.p.lastsort,f);
    if(j.p.treeGrid)j.p.expColInd=b.inArray(j.p.expColInd,f)
        },
setGridWidth:function(f,k){
    return this.each(function(){
        var i=this,h,g=0,j=i.p.cellLayout,m,a=0,q=false,u=i.p.scrollOffset,y,B=0,K=0,J=0,F;
        if(i.grid){
    ...
    return this.each(function(){
        ...
        if(m>=0)if(a=j.rows.namedItem(f)){
            ...
            if(i!==""){
                ...
                if(typeof h==="string")h?b(q).addClass(h):b(q).removeClass();else h&&b(q).css(h);
...
c.unformat=function(a,b,d,e){
    var h,g=b.colModel.formatter,f=b.colModel.formatoptions||{},i=/([\.\*\_\'\(\)\{\}\+\?\\])/g;
...
filterGrid:function(d,o){
    ...
    return this.each(function(){
        ...
        if(this.p.filterModel.length==0&&this.p.gridModel===false)alert("No filter is set");
            ...
            var f=function(){
                var c={},g=0,n,h=a(b.p.gridid)[0],j;
                h.p.searchdata={};
    ...
    var c={},g,n=0,h=a(b.p.gridid)[0],j;
...
},m=a("<form name='SearchForm' style=display:inline;' class='"+this.p.formclass+"'></form>"),e=a("<table class='"+this.p.tableclass+"' cellspacing='0' cellpading='0' border='0'><tbody></tbody></table>");
a(m).append(e);
(function(){
    var c=document.createElement("tr"),g,n,h,j;
    ...
    a.each(b.p.filterModel,function(q){
        ...
        switch(this.stype){
            case "select":
                ...
                var r=i.sopt.value,u=document.createElement("select");
                a(u).attr({
                    name:i.index||i.name,
                    id:"sg_"+i.name
                    }).attr(i.sopt);
        ...
        a.each(b.p.colModel,function(){
            ...
            if(this.search)switch(this.stype){
                case "select":
                    ...
                    dataType:"html",
                    complete:function(q){
                        if(e.buildSelect!=null)(q=e.buildSelect(q))&&a(k).append(q);else a(k).append(q.responseText);
...
if(d.stringResult){
    var n='{"groupOp":"'+d.groupOp+'","rules":[',h=0;
...
var showModal=function(a){
    ...
    if(jQuery.fn.jqm&&c.jqModal===true){
        ...
        var n=jQuery("#"+a.themodal).data("onClose")||c.onClose,k=jQuery("#"+a.themodal).data("gbox")||c.gbox;
...
(function(a){
    ...
    a.jgrid.extend({
        searchGrid:function(h){
            ...
            return this.each(function(){
                function b(r){
                    var v=r!==undefined,B=a("#"+w.p.id),I={};
                    ...
                    var v=a("#"+w.p.id),B=[];
                    v[0].p.search=r;
                    if(h.multipleSearch===false)B[h.sField]=B[h.sValue]=B[h.sOper]="";else B[h.sFilter]="";
            ...
            if(w.grid)if(a.fn.searchFilter){
                ...
                if(a("#"+q).html()!=null){
                    ...
                    var n=[],m=a("#"+w.p.id).jqGrid("getGridParam","colNames"),F=a("#"+w.p.id).jqGrid("getGridParam","colModel"),f=["eq","ne","lt","le","gt","ge","bw","bn","in","ni","ew","en","cn","nc"],e,j,i,k;
    ...
    if(n.length>0){
        ...
        if(h.drag===true){
            ...
            if(jQuery.fn.jqDrag)a("#"+q).jqDrag(a("#"+q+" table thead tr:first td:first"));else try{
                a("#"+q).draggable({
                    handle:a("#"+
...
editGridRow:function(h,
    ...
    return this.each(function(){
        function o(g,l){
            ...
            function x(){
            var g=
            a(f).jqGrid("getDataIDs"),l=a("#id_g","#"+i).val();
        ...
        a(G).each(function(){
            ...
            if(A[0]!=null){
                ...
                if(K.defaultValue){
                    ...
                    y=a(A).attr("offval")
                    }else if(A[0].type.substr(0,6)=="select")A[0].selectedIndex=0;else A.val(y);
    ...
    if(Q){
        a("td",Q).each(function(H){
            ...
            if(p!=="cb"&&p!=="subgrid"&&p!=="rn"&&G[H].editable===true){
                if(p==
                    l.p.ExpandColumn&&l.p.treeGrid===true)z=a(this).text();else try{
                    z=a.unformat(this,{
                        rowId:g,
                        colModel:G[H]
                        },H)
                ...
                switch(G[H].edittype){
                    ...
                    case "custom":
                        try{
                        if(G[H].editoptions&&a.isFunction(G[H].editoptions.custom_value))G[H].editoptions.custom_value(a("#"+p,"#"+C),"set",z);else throw"e1";
                    }catch(ba){
...
function F(g,l){
    ...
    var f=this;
if(f.grid&&h){
    var e=f.p.id,j="FrmGrid_"+e,i="TblGrid_"+e,k={
        themodal:"editmod"+e,
        modalhead:"edithd"+e,
        modalcontent:"editcnt"+e,
        scrollelm:j
    },u=
    a.isFunction(d.beforeShowForm)?d.beforeShowForm:false,P=a.isFunction(d.afterShowForm)?d.afterShowForm:false,r=a.isFunction(d.beforeInitData)?d.beforeInitData:false,v=a.isFunction(d.onInitializeForm)?d.onInitializeForm:false,B=1,I=0,Z,c,t,J,S;
    if(h=="new"){
        h="_empty";
    ...
    if(a("#"+k.themodal).html()!=null){
        ...
        var N=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px",D;
        ...
        var $="<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>"+b.bSubmit+"</a>",aa="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bCancel+"</a>";
...
viewGridRow:function(h,
    ...
    return this.each(function(){
        function o(){
            ...
            function s(){
            var c=a(n).jqGrid("getDataIDs"),t=a("#id_g","#"+f).val();
            ...
            a(t.p.colModel).each(function(){
                ...
                if(!N&&this.align==="right")if(this.formatter&&a.inArray(this.formatter,l)!==-1)C=Math.max(C,parseInt(this.width,10));else p=Math.max(p,parseInt(this.width,10))
                    });
            E=C!==0?C:p!==
            0?p:0;
            ...
            a(t.p.colModel).each(function(y){
                ...
                if(M!=="cb"&&M!=="subgrid"&&M!=="rn"&&A){
                    ...
                    var L=a.extend({},{
                        rowabove:false,
                        rowcontent:""
                    },this.formoptions||{}),G=parseInt(L.rowpos)||O+1,Q=parseInt((parseInt(L.colpos)||1)*2);
                    if(L.rowabove){
...
if(n.grid&&h){
    if(!b.imgpath)b.imgpath=
        n.p.imgpath;
    var m=n.p.id,F="ViewGrid_"+m,f="ViewTbl_"+m,e={
        themodal:"viewmod"+m,
        modalhead:"viewhd"+m,
    ...
    if(a("#"+e.themodal).html()!=null){
        ...
        var k=isNaN(b.dataheight)?b.dataheight:b.dataheight+"px",u=a("<form name='FormPost' id='"+F+"' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:"+k+";'></form>"),P=a("<table id='"+f+"' class='EditTable' cellspacing='1' cellpading='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
        a(u).append(P);
        w(h,n,P,j);
        ...
        v="<a href='javascript:void(0)' id='"+(k?"pData":"nData")+"' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></div>",B="<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>"+b.bClose+"</a>";
        if(i>0){
            var I=[];
...
delGridRow:function(h,b){
    ...
    return this.each(function(){
        var o=this;
        if(o.grid)if(h){
            var x=typeof b.beforeShowForm==="function"?true:false,s=typeof b.afterShowForm==="function"?true:false,w=o.p.id,q={},n="DelTbl_"+w,m,F,f,e,j={
                themodal:"delmod"+w,
                modalhead:"delhd"+w,
...
navGrid:function(h,b,o,x,s,w,q){
    ...
    return this.each(function(){
        ...
        if(!(!m.grid||typeof h!=
            ...
            for(f=0;f<F;f++){
                var j=a("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),i,k;
                if(f==0){
                    i=h;
                    k=m.p.id;
                    if(i==m.p.toppager){
    ...
    return this.each(function(){
        if(this.grid){
            ...
            if(o){
                ...
                if(b.position=="first")o.rows[0].cells.length===0?a("tr",o).append(s):a("tr td:eq(0)",o).before(s);else a("tr",o).append(s);
...
FormToGrid:function(h,b,o,x){
    return this.each(function(){
        ...
        if(s.grid){
            o||(o="set");
            x||(x="first");
            var w=a(b).serializeArray(),q={};
            
            a.each(w,function(n,m){
                q[m.name]=m.value
                });
            if(o=="add")a(s).jqGrid("addRowData",h,q,x);else o=="set"&&a(s).jqGrid("setRowData",h,q)
                }
            })
}
})
    ...
    function C(c,i,k){
        ...
        if(i!=null){
            function w(){
                ...
                var d=jQuery.extend({},
                jQuery.fn.searchFilter.defaults,k),m=-1,q="";
            ...
            k=c.find("tr.sf");
            var A=k.find("td.fields"),u=k.find("td.ops"),n=k.find("td.data"),r="";
            ...
            jQuery.each(i,function(a){
                ...
                if(this.ops!=null){
                    ...
                    if(a>m)m=a;
                    o=true;
                    var e=this.dataEvents,j=this.dataInit,p=this.buildSelect;
        ...
        c.find(".ui-search").click(function(){
            var a=jQuery(c.selector),b,e=a.find("select[name='groupOp'] :selected").val();
        ...
        c.find(".ui-add-last").click(function(){
            var a=jQuery(c.selector+" .sf:last"),b=a.clone(true).insertAfter(a);
            b.find(".ui-state-default").removeClass("ui-state-hover ui-state-active");
            b.find(".data input").val("");
            b.find("select[name='field']").focus();
            d.datepickerFix===true&&jQuery.fn.datepicker!==undefined&&a.find(".hasDatepicker").each(function(){
...
(function(a){
    a.jgrid.extend({
        editRow:function(d,t,i,q,n,u,s,c,f){
            return this.each(function(){
                var b=this,k,l,r=0,o=null,p={},h,g;
                if(b.grid){
...
if(!a("#colchooser_"+g[0].p.id).length){
    var d=a('<div id="colchooser_'+g[0].p.id+'" style="position:relative;overflow:hidden"><div><select multiple="multiple"></select></div></div>'),e=a("select",d);
    b=a.extend({
        width:420,
        height:240,
        classname:null,
...
if(b.classname){
    ...
    var h=g.jqGrid("getGridParam","colModel"),j=g.jqGrid("getGridParam","colNames"),l={},m=[];
e.empty();
a.each(h,function(f){
    l[this.name]=f;
    if(this.hidedlg)this.hidden||m.push(f);else e.append("<option value='"+f+"' "+
